...
$(document).ready(function whitelist(){
  $(document).ready(function(){
    $.getJSON("https://nodes.wavesnodes.com/assets/FiKspxSpkpzT4pMUA9ccZkbJmVXTdu4JhFDXNNXr5noW/distribution?t=", function(result){
      $.each(result, function(i, field){
        $("tbody").append("<tr>"+ "<td class='searchable'>" + i + "</td>" + "<td>" + (field/100).toLocaleString() + "</td>"+"</tr>");
  ...
  xhttp.onreadystatechange = function() {
    ...
    var text = this.responseText
      var obj = JSON.parse(text);
		...
		document.getElementById("totalsupply").innerHTML = "Total supply:" + " " + totalsupply.toLocaleString();
...
document.getElementById("total").innerHTML = "Total circulating:" + " " + circulating.toLocaleString();
...
document.getElementById("amountlocked").innerHTML = "Total locked:" + " " + locked.toLocaleString() + "  (locked until 20/06/2020)";
